...
//#endregion
//#region ../client/src/views/About.vue
var _sfc_main = {
	name: "About",
	components: { AboutStackOverview: /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-34809fa9"]]) }
};
...
var about_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(About_default, _attrs, null, _parent));
		};
	}
});
//#endregion
...
//# sourceMappingURL=about-CnQtHoFp.mjs.map
