...
import { getCurrentScope, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, shallowReactive, reactive, effectScope, hasInjectionContext, createApp, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, inject, defineAsyncComponent, mergeProps, toRef, shallowRef, isReadonly, defineComponent, createElementBlock, cloneVNode, h, toRaw, computed, useSSRContext, isRef, isShallow, isReactive, isVNode, createCommentVNode, withCtx, Suspense, nextTick, Fragment, resolveComponent, toValue, queuePostFlushCb } from 'vue';
import { i as createError, $ as $fetch, o as hasProtocol, l as joinURL, q as defu, w as withQuery, v as sanitizeStatusCode, x as parseURL, e as encodePath, y as decodePath, z as parseQuery, A as isScriptProtocol, B as withTrailingSlash, C as withoutTrailingSlash } from '../_/nitro.mjs';
...
var namedMiddleware = { auth: () => import('../build/auth-CDAKK7AI.mjs') };
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		name: "Anime",
		path: "/anime/:id()",
		component: () => import('../build/_id_-CZB6-K0V.mjs')
	},
	{
		name: "Book",
		path: "/books/:id()",
		component: () => import('../build/_id_-BU5_iseR.mjs')
	},
	{
		name: "Discussion",
		path: "/discussion/:id()",
		component: () => import('../build/_id_-CKMLsMLk.mjs')
	},
	{
		name: "Manga",
		path: "/manga/:id()",
		component: () => import('../build/_id_-BlAmRW5S.mjs')
	},
	{
		name: "Movie",
		path: "/movies/:id()",
		component: () => import('../build/_id_-BRHgODqP.mjs')
	},
	{
		name: "Profile",
		path: "/profile/:username()",
		component: () => import('../build/_username_-QLfMwcCx.mjs')
	},
	{
		name: "Review",
		path: "/review/:id()",
		component: () => import('../build/_id_-B3gkBk9p.mjs')
	},
	{
		name: "Tv",
		path: "/tv/:id()",
		component: () => import('../build/_id_-B5Cy9RmY.mjs')
	},
	{
		name: "About",
		path: "/about",
		component: () => import('../build/about-CnQtHoFp.mjs')
	},
	{
		name: "AdminPanel",
		path: "/admin",
		component: () => import('../build/admin-Ct8MIUqz.mjs')
	},
	{
		name: "AnimeBrowse",
		path: "/anime",
		component: () => import('../build/anime-DwrhHbbJ.mjs')
	},
	{
		name: "BookBrowse",
		path: "/books",
		component: () => import('../build/books-Dqo1R86_.mjs')
	},
	{
		name: "Discussions",
		path: "/discussions",
		component: () => import('../build/discussions-DvDV9NlF.mjs')
	},
	{
		name: "Inbox",
		path: "/inbox",
		component: () => import('../build/inbox-B_BfPrGU.mjs')
	},
	{
		name: "LoginRegister",
		path: "/login",
		component: () => import('../build/login-CWg2Ly7s.mjs')
	},
	{
		name: "MangaBrowse",
		path: "/manga",
		component: () => import('../build/manga-D5HPUdaN.mjs')
	},
	{
		name: "MovieBrowse",
		path: "/movies",
		component: () => import('../build/movies-bwgbNVkg.mjs')
	},
	{
		name: "Reviews",
		path: "/reviews",
		component: () => import('../build/reviews-Bgax4G3i.mjs')
	},
	{
		name: "Settings",
		path: "/settings",
		component: () => import('../build/settings-DgdWp0h9.mjs')
	},
	{
		name: "TvBrowse",
		path: "/tv",
		component: () => import('../build/tv-CJuSK3Z2.mjs')
	},
	{
		name: "Home",
		path: "/",
		component: () => import('../build/pages-BIBnh3Hy.mjs')
	}
];
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Flayouts_default = { default: defineAsyncComponent(() => import('../build/default-ufEOkCqx.mjs').then((m) => m.default || m)) };
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-00McUvqw.mjs'));
		const _Error = defineAsyncComponent(() => import('../build/error-500-DLiZ5jLp.mjs'));
...
export { $fetch$2 as $, ClientOnly as C, NuxtLink as N, _plugin_vue_export_helper_default as _, useRoute$1 as a, useHead$1 as b, entry as c, defineNuxtRouteMiddleware as d, executeAsync as e, navigateTo as n, useRequestFetch as u };
